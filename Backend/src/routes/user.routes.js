...
import {getAuthStatus, getUserProfile, getWatchHistory, registerUser, removeVideoFromHistory} from '../controllers/user.controller.js'
...
router.route('/getAuthStatus').get(getAuthStatus)

router.route('/deleteFromHistory').post(verifyToken,removeVideoFromHistory)
